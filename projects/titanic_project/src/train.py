...
plt.ylabel('准确率')
plt.title('四模型准确率对比')
plt.savefig('AI-learning/projects/titanic_project/images/model_comparison.png', dpi=150, bbox_inches='tight')
plt.close()
...
plt.title('随机森林 - 混淆矩阵')
plt.savefig('AI-learning/projects/titanic_project/images/confusion_matrix.png', dpi=150, bbox_inches='tight')
plt.close()
